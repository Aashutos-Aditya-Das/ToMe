...
An update is binary. It either fully succeeds or it fully aborts. Partial updates to the `.tome/` directory are physically impossible due to the `.tmp` rename strategy.
